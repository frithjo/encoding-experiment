...
def run_experiment(vindex_path: str):
    ...
    # Extract model name from path for results directory
    # vindex_path is like: /path/to/data/bitnet_b1_58-large/vindex
    # We want results in: /path/to/data/bitnet_b1_58-large/results
    vindex_dir = os.path.dirname(vindex_path)  # /path/to/data/bitnet_b1_58-large
    model_name = os.path.basename(vindex_dir)  # bitnet_b1_58-large
    results_dir = os.path.join(vindex_dir, "results")
    os.makedirs(results_dir, exist_ok=True)
    results_path = os.path.join(results_dir, "01_gate_cosine.json")
