...
- Role: Experimental benchmark/prototyping harness for KV strategies
- Zone: experimental
- Release impact: low
...
- Public: benchmark scenarios, reported metrics, and reproducibility guidance.
- Internal: prototype algorithms and experimental implementation paths are not
