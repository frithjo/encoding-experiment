    ...
    #[cfg(feature = "metal")]
    {
        ...
        // ── v2: 4 rows per thread, f32 input ──
        {
            ...
            bench_metal(
                "v2 (4-row, f32 in)",
                &pipeline,
                MTLSize::new(n_threads.div_ceil(256), 1, 1),
                MTLSize::new(256, 1, 1),
                &|enc, buf_out| {
