...
- Name: batch_dla_scan_ui.spec.ts >> Batch DLA Scan UI >> input interaction - textarea accepts text
- Location: tests/batch_dla_scan_ui.spec.ts:8:7
...
Locator: locator('textarea[placeholder="Enter text to analyze..."]')
Expected: visible
Timeout: 5000ms
